---
description: 疾病,关联蛋白,分子胶潜力分析
---

# 项目标题

基于公开 API 的「疾病 → 关联蛋白 → 分子胶潜力」分析，并在 PyMOL 中可视化（单机插件），方便结构研究者按疾病筛选潜在分子胶靶点。
...
> 不做 Web，只做一个可以在本地 PyMOL 使用的插件/脚本：
>
> * 接收任意疾病名；
> * 用 API 找到关联蛋白；
...
> 上面这份文档可以直接当作 “AI 工程师 / Python 工程师” 的需求说明书或提示词，让对方按照模块拆分实现。
