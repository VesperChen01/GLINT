...
class LeadOptimizationTab(CommonTab):
    ...
    def init_ui(self):
        ...
        # Contact Cutoff（接触区截断距离）
        ec_grid.addWidget(QLabel("Contact Cutoff (Å):"), 4, 0, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.parent_window.ec_contact_cutoff = QLineEdit("10.0"); self.parent_window.ec_contact_cutoff.setMinimumHeight(32)
        ...
        ec_grid.addWidget(QLabel("Advanced Options:"), 5, 0, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        ...
        ec_grid.addWidget(self.parent_window.ec_use_sigma_holes, 5, 1)
        ...
        ec_grid.addWidget(self.parent_window.ec_keep_waters, 6, 3)
    ...
    def run_ppi_analysis(self):
        ...
        try:
            ...
            try:
                from ...color_scheme import VisualizationSettings
            except ImportError:
                from color_scheme import VisualizationSettings
    ...
    def run_ec_analysis(self):
        ...
        try:
            ...
            contact_cutoff = float(self.parent_window.ec_contact_cutoff.text().strip() or "10.0")
            ...
            self.log(f"  pH: {ph}")
            self.log(f"  Contact Cutoff: {contact_cutoff} Å")
