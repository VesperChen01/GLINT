...
def write_enhanced_pqr(output_file: str,
    ...
    try:
        with open(output_file, 'w') as f:
            ...
            f.write("REMARK Generated by GlueTK ec_advanced_patches\n")
...
def print_module_info():
    """打印模块信息"""
    print("="*60)
    print("GlueTK EC Advanced Patches Module")
    print("="*60)
    print("\nFeatures:")
    ...
    print("\nUsage:")
    print("  from gluetk.ec_advanced_patches import EnhancedChargeCalculator")
