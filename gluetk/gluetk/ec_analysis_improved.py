...
class ECAnalysisManager:
    ...
    def get_pdb2pqr_runner(self):
        """获取 PDB2PQR 运行器"""
        from gluetk.ligand_ec_calculator import PDB2PQRRunner
        return PDB2PQRRunner()
    
    def get_apbs_runner(self):
        """获取 APBS 运行器"""
        from gluetk.ligand_ec_calculator import APBSRunner
        return APBSRunner()
...
1. 检查依赖:
   python3 -c "from gluetk.ec_analysis_improved import quick_diagnose; quick_diagnose()"
...
更多信息: https://github.com/VesperChen01/GlueTK
    """)
