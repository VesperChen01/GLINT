...
"""
color_scheme.py
Unified color scheme for GlueTK - Schrödinger-inspired professional palette

This module provides a consistent color scheme across all GlueTK modules including:
...
RESIDUE_COLORS_HEX = {
    'hydrophobic': {'face': '#C5E1A5', 'edge': '#4CAF50', 'text': '#2E7D32'},
    'nonpolar':    {'face': '#FFE0B2', 'edge': '#FF9800', 'text': '#E65100'},
    'polar':       {'face': '#BBDEFB', 'edge': '#2196F3', 'text': '#1565C0'},
    'negative':    {'face': '#A5D6A7', 'edge': '#388E3C', 'text': '#1B5E20'},
    'positive':    {'face': '#FFCDD2', 'edge': '#E57373', 'text': '#C62828'},
}
